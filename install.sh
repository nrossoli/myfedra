...
LIBS="libEdb libEbase libDataConversion libEmath libEGA libEphys libEdr libEIO libEdd libEMC libMosaic libAlignment libScan libShower libEOracle libEmr libEDA libShowRec"
...
mv $PROJECT_SRC/*/*.pcm $installdir/lib
mv $PROJECT_SRC/*/*/*.pcm $installdir/lib
cd $installdir
