...
//-			VARIABLES
//---------------------------------------------------------------------------------
Int_t cmd_HELP=0; // Print all the possible help options.
//----------------------------------------------------
Int_t cmd_PRESET=0; // Sets all other values for a given preset.
//----------------------------------------------------
Int_t cmd_PADI=0;
Int_t cmd_BTPA=0;
Int_t cmd_BGTP=0;
...
Int_t cmd_MCFL=0;
Int_t cmd_HPLZ=0;
Int_t cmd_ALI=0;  // 0 gAli from cp, 1: gALI from Linkd_tracks 2: gAli from root file
Int_t cmd_MCMIX=0;
Int_t cmd_vtx=0;
...
// void FillGlobalInBTArray();  // deprecated
...
void ReconstructShowers_OI2(); // DEPRECATED !!!!
...
void ReconstructShowers_N3(); // ALTP=11
// -------------------------------
...
void Finalize();
// Set Parameters from command line Inputs
void SetPresetParameters(Int_t cmd_PRESET);
//---------------------------------------------------------------------------------
//   Help functions - mostly printing functions
void PrintHelp();
