{
	...
	TFile *PARAMETERSET_DEFINITIONFILE_SHORT = new TFile("PARAMETERSET_DEFINITIONFILE_LONG_CT_ALG.root","RECREATE");
...
//	Double_t CUT_ZYLINDER_ANGLE_MAX_ARRAY={};
	...
	Int_t ParaSetNr=0;
	ofstream outstream;
	TString OutputFile="PARAMETERSET_DEFINITIONFILE_LONG_CT_ALG.txt";
