{
    TFile *PARAMETERSET_DEFINITIONFILE_SHORT = new TFile("PARAMETERSET_DEFINITIONFILE_LONG_N3_ALG.root","RECREATE");
...
// ParaSetNr  ANN_INPUTLEVEL ANN_PLATE_DELTANMAX ANN_PLATEDIRECTION  ANN_NHIDDENLAYER ANN_OUTPUTTHRESHOLD   ANN_INPUTNEURONS
    ...
    Int_t ParaSetNr=0;
    ofstream outstream;
    TString OutputFile="PARAMETERSET_DEFINITIONFILE_LONG_N3_ALG.txt";
